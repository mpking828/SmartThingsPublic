 ...
 */
definition(
    name: "BETA Thermostat On/Off Mapper",
    namespace: "gouldner",
...
def uninstalled() {
// Originally I had unsubscribe and removeAllChildDevices call here
// but uninstall fails if child devices have subscriptions
// so now you have to use preferences to remove the device reference
// which will remove the subscriptions and child devices when "done" is 
// pressed and initialize is called.
// Then you can re-open preferences and select uninstall
unsubscribe()
runIn(300, removeAllChildDevices)
}
