...
metadata {
	definition (
        ...
        // Not sure why original version had both old style finger print and new style.
	...
	tiles(scale: 2) {
	    ...
	    details(["status", "playAlarm", "playSiren1", 
                 "playSiren2", "playChime1", "playChime2", 
                 "playChime3", "playBell1", "playBell2", 
                 "playBell3", "playBell4",  "playBell5", 
                 "battery", "refresh" 
                ])
