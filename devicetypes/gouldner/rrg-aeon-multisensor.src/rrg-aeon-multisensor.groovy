metadata {
	...
	definition (name: "RRG Aeon Multisensor", namespace: "gouldner", author: "Ronald Gouldner") {
	...
	tiles {
        ...
        // It never reaches < 59 so making < 70 Blue
        // Normal temp is 70-78 so making 70-78 Light Green
        // Over 79 is Hot so making it red
		valueTile("temperature", "device.temperature", inactiveLabel: false) {
			state "temperature", label:'${currentValue}°',
			backgroundColors:[
				[value: 31, color: "#153591"],
		...
		valueTile("illuminance", "device.illuminance", inactiveLabel: false) {
			state "luminosity", label:'I${currentValue}${unit}', unit:"lux"
		}
